	    ...
	    <div class='headline'>
	      ...
	      <div class='Ranking'>
					...
					<svg xmlns='http://www.w3.org/2000/svg' width='60.001' height='60' viewBox='0 0 60.001 60'>
						<g id='Group_8' data-name='Group 8' transform='translate(-47 -66)'>
							...
							<text id='R2' transform='translate(57.188 106.604)' fill='#8b8686' font-size='30' font-family='Montserrat-Bold, Montserrat' font-weight='700'><tspan x='0' y='0'>R4</tspan></text>
						</g>
					</svg>
	      </div>
	      ...
	      <div class='cID'>
	        ...
	        <svg xmlns='http://www.w3.org/2000/svg' width='150 ' height='37' viewBox='0 0 78 37'>
	          <text id='_CN1' data-name='#CN1' transform='translate(0 29)' fill='#7a7a7a' font-size='30' font-family='Montserrat-Regular, Montserrat'><tspan x='0' y='0'>#CON2</tspan></text>
	        </svg>
	    </div>
